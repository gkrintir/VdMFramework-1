...
class  SimRatio_PCCAndVtxNoConst_Fit(FitManager.FitProvider):
...
# see http://root.cern.ch/phpBB3/viewtopic.php?f=14&t=14473, http://root.cern.ch/phpBB3/viewtopic.php?f=13&t=16844, https://agenda.infn.it/getFile.py/access?resId=1&materialId=slides&confId=4933 slide 23
        ...
        # [0]: #StartSigma[0], [1]: #sigma_{1}/#sigma_{2} =1, 2:StartPeak[0], 3: StartFrac[0], 4: Mean, 5: StartSigma[1], 6: StartPeak[1], 7: StartFrac[1], 8: Mean
        ...
        # 5: #Sigma , 1: #sigma_{1}/#sigma_{2} (common parameter), 6: Amp, 7: Frac, 8: Mean
