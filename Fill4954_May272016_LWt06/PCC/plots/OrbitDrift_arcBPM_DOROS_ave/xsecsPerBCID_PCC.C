...
//=========  (Sun Nov 19 13:38:25 2017) by ROOT version5.99/05
   TCanvas *can = new TCanvas("can", "",1,1,800,576);
   can->SetHighLightColor(2);
   can->Range(-283.15,8.367902,2548.35,8.515859);
   can->SetFillColor(0);
   can->SetBorderMode(0);
   can->SetBorderSize(2);
   ...
   Graph_Graph1006->SetMinimum(8.382698);
   Graph_Graph1006->SetMaximum(8.501063);
